...
VISTA's database is a VA-developed hierachical file store called VA File Manager (VA Fileman).  VA Fileman is the transactional database of VISTA managing all healthcare transactions at all VHA care sites across the United States. VA Fileman is indexed on a per-patient basis and optimized for performance for the clinical staff to provide veteran care.  Each day VA Fileman enables 350,000 staff perform over 200 million transactions with sub-second latency with 99.999996% uptime (less than one second of downtime a month). In 2023,  VA Fileman supported over 110 million veteran care encounters.  

...
Comprehensive full-fidelity replication of VA Fileman into a cloud-native Document database (preserving all Fileman data and nuance - all files, fields, pointers, cross reference, and metadata)  will allow comprehensive continuity of access,  management, and query of all Veteran health data in a modern mainstream commercially-supported cloud-native database via a comprehensive query API, making all VISTA data available for all VA analytical and AI systems. (Figure 1).

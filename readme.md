...
VA Fileman is the database of VISTA managing the operations of over 1250 hospitals and clinics across the United States. It is optimized for transaction processing, performance, and reliability for veteran care. Each day VA Fileman enables 350,000 staff perform over 200 million transactions with sub-second latency and 99.999996% uptime (less than one second of downtime a month). VA Fileman is indexed on a per-patient basis and optimized for performance for the clinical staff to provide veteran care. 
